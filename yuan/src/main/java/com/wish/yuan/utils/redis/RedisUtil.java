package com.wish.yuan.utils.redis;
...
//=============================common============================
     ...
     */
    public static boolean hashMapSet(String key, Map<String, Object> map) {
        try {
     ...
     * @return true成功 false失败
     */
    public static boolean hashMapSet(String key, Map<String, Object> map, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            if (time > 0) {
                expire(key, time);
     ...
     * @return true 存在 false不存在
     */
    public static boolean hashKey(String key, String item) {
